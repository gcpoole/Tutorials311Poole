...
```{r display_sum, exercise=TRUE}

```

```{r display_sum-solution}
sum
```

```{r display_sum-code-check}
grade_code()
```
...
```{r display_my_list-setup}
my_list <- list(letters, 1:10, sum)
```

```{r display_my_list, exercise=TRUE}

```

```{r display_my_list-solution}
my_list
```

```{r display_my_list-code-check}
grade_code()
```
...
```{r shorten_my_list-setup}
my_list <- list(letters, 1:10, sum)
```

```{r shorten_my_list, exercise=TRUE}

```

```{r shorten_my_list-solution}
my_short_list <- my_list[c(1,3)]
my_short_list
is.list(my_short_list)
```

```{r shorten_my_list-code-check}
grade_code()
```
...
```{r length_1_list-setup}
my_list <- list(letters, 1:10, sum)
```

```{r length_1_list, exercise=TRUE}

```

```{r length_1_list-solution}
length_1_list <- my_list[2]
length_1_list
is.list(length_1_list)
```

```{r length_1_list-code-check}
grade_code()
```
...
```{r extract_integer_vector-setup}
my_list <- list(letters, 1:10, sum)
```

```{r extract_integer_vector, exercise=TRUE}
# Note the double brackets...
my_integer_vector <- my_list[[2]]
```

```{r extract_integer_vector-solution}
# Note the double brackets...
my_integer_vector <- my_list[[2]]
...
```{r extract_integer_vector-code-check}
grade_code()
```
...
```{r try_extraction-setup}
my_list <- list(letters, 1:10, sum)
```

```{r try_extraction, exercise=TRUE}
identical(1:10, my_list[2])
```

```{r try_extraction-solution}
identical(1:10, my_list[[2]])
```

```{r try_extraction-code-check}
grade_code()
```
...
```{r name_my_list-setup}
my_list <- list(letters, 1:10, sum)
```

```{r name_my_list, exercise=TRUE}

```

```{r name_my_list-solution}
names(my_list) <- c("letters", "integers", "sum_function")
my_list
```

```{r name_my_list-code-check}
grade_code()
```
...
```{r name_when_creating_list, exercise=TRUE}
my_list <- list(letters, 1:10, sum)
```

```{r name_when_creating_list-solution}
my_list <- list(letters = letters, integers = 1:10, sum_function = sum)
my_list
```

```{r name_when_creating_list-code-check}
grade_code()
```
...
```{r index_extract_by_name-setup}
my_list <- list(letters, 1:10, sum)
names(my_list) <- c("letters", "integers", "sum_function")
```

```{r index_extract_by_name, exercise=TRUE}

```

```{r index_extract_by_name-solution}
my_list[c("letters", "sum_function")]
my_list["integers"]
my_list[["integers"]]
```

```{r index_extract_by_name-code-check}
grade_code()
```
...
```{r dollar_vs_double_square-setup}
my_list <- list(letters, 1:10, sum)
names(my_list) <- c("letters", "integers", "sum_function")
```

```{r dollar_vs_double_square, exercise=TRUE}

```

```{r dollar_vs_double_square-solution}
identical(my_list$integers, my_list[["integers"]])
```

```{r dollar_vs_double_square-code-check}
grade_code()
```
...
```{r str_mtcars, exercise=TRUE}

```

```{r str_mtcars-solution}
str(mtcars)
```

```{r str_mtcars-code-check}
grade_code()
```
...
```{r head_letters_mtcars, exercise=TRUE}

```

```{r head_letters_mtcars-solution}
head(letters)
head(mtcars)
```

```{r head_letters_mtcars-code-check}
grade_code()
```
...
```{r head_letters_mtcars_10, exercise=TRUE}

```

```{r head_letters_mtcars_10-solution}
head(letters, 10)
head(mtcars, 10)
```

```{r head_letters_mtcars_10-code-check}
grade_code()
```
...
```{r nrow_ncol, exercise=TRUE}

```

```{r nrow_ncol-solution}
nrow(mtcars)
ncol(mtcars)
```

```{r nrow_ncol-code-check}
grade_code()
```
...
```{r df_is_list, exercise=TRUE}

```

```{r df_is_list-solution}
is.list(mtcars)
```

```{r df_is_list-code-check}
grade_code()
```
...
```{r names_of_mtcars, exercise=TRUE}

```

```{r names_of_mtcars-solution}
names(mtcars)
str(mtcars)
```

```{r names_of_mtcars-code-check}
grade_code()
```
...
```{r length_vs_ncol, exercise=TRUE}

```

```{r length_vs_ncol-solution}
length(mtcars)
ncol(mtcars)
```

```{r length_vs_ncol-code-check}
grade_code()
```
...
```{r extract_columns, exercise=TRUE}

```

```{r extract_columns-solution}
mpg_col <- mtcars$mpg
mpg_col
is.vector(mpg_col)
col_6 <- mtcars[[6]]
...
```{r col_length_vs_nrows-setup}
mpg_col <- mtcars$mpg
col_6 <- mtcars[[6]]
```

```{r col_length_vs_nrows, exercise=TRUE}

```

```{r col_length_vs_nrows-solution}
length(mpg_col)
length(col_6)
nrow(mtcars)
```

```{r col_length_vs_nrows-code-check}
grade_code()
```
...
```{r mean_disp, exercise=TRUE}

```

```{r mean_disp-solution}
mean(mtcars$disp)
range(mtcars$mpg)
unique(mtcars$cyl)
```

```{r mean_disp-code-check}
grade_code()
```
...
```{r index_mtcars_as_list_1, exercise=TRUE}

```

```{r index_mtcars_as_list_1-solution}
three_column_mtcars <- mtcars[c(1,4,6)]
head(three_column_mtcars, 4)
```

```{r index_mtcars_as_list_1-code-check}
grade_code()
```
...
```{r index_mtcars_as_list_2, exercise=TRUE}

```

```{r index_mtcars_as_list_2-solution}
three_column_mtcars <- mtcars[c("mpg", "hp", "wt")]
head(three_column_mtcars, 5)
```

```{r index_mtcars_as_list_2-code-check}
grade_code()
```
...
```{r index_mtcars_as_list_3, exercise=TRUE}

```

```{r index_mtcars_as_list_3-solution}
three_column_mtcars <- 
  mtcars[c(TRUE, FALSE, FALSE, TRUE, FALSE, TRUE, FALSE, FALSE, FALSE, FALSE, FALSE)]
head(three_column_mtcars, 3)
```

```{r index_mtcars_as_list_3-code-check}
grade_code()
```
...
```{r index_mtcars_2D_1, exercise=TRUE}

```

```{r index_mtcars_2D_1-solution}
has_poor_fuel_economy <- mtcars$mpg < 15
mtcars[has_poor_fuel_economy, c("mpg", "cyl", "hp", "wt", "gear")]
```

```{r index_mtcars_2D_1-code-check}
grade_code()
```
...
```{r index_mtcars_2D_2-setup}
has_poor_fuel_economy <- mtcars$mpg < 15
```

```{r index_mtcars_2D_2, exercise=TRUE}

```

```{r index_mtcars_2D_2-solution}
mtcars[has_poor_fuel_economy, ]
```

```{r index_mtcars_2D_2-code-check}
grade_code()
```
...
```{r index_then_extract, exercise=TRUE}

```

```{r index_then_extract-solution}
mean(mtcars[mtcars$cyl == 4, ]$disp)
mean(mtcars[mtcars$cyl == 6, ]$disp)
mean(mtcars[mtcars$cyl == 8, ]$disp)
```

```{r index_then_extract-code-check}
grade_code()
```
