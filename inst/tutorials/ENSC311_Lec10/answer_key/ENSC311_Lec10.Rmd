...
```{r filter_mean, exercise = tutorialize}
...
```{r filter_mean_plot, exercise = tutorialize, exercise.setup = filter_mean}
...
```{r box_with_color, exercise = tutorialize}
...
```{r bill_length, exercise = tutorialize}
...
```{r final_plot_df, exercise = tutorialize, exercise.setup = filter_mean}
...
```{r facet_by_sex, exercise = tutorialize}
...
```{r final_plot, exercise = tutorialize}
